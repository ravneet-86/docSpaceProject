...
class CustomEntry(tk.Entry):
    ...
    def __init__(self, master=None, max_len=10, alpha=True, digit=False, special_char=False,
                 space_allowed=False, callback_fun=None, **kwargs):
        ...
        self.var.trace('w', lambda name, index, mode: self.check())
    ...
    def check(self, *args):
        ...
        if ENABLE_DEBUG:
            print("Running custom entry text check on ", self.get(), self.var.get(), type(self.var))
        ...
        try:
            ...
            # Run the callback function set during class init.
