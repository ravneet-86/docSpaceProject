...
from frames.search_remedy_frame import SearchRemedyFrame
from utils import *
...
class FrameController:
    ...
    def start_app_frame(self):
        ...
        # For test directly go to search remedy frame.
        # self.search_remedy_frame.frame.display_frame()
        self.root.mainloop()

    # Init the frame controller class.
    def __init__(self, root, db_controller, remedy_db_controller, remedy_searcher):
        ...
        self.entry_frame = EntryFrame(self.root, ws, hs, self.db_controller)
        ...
        self.search_remedy_frame = SearchRemedyFrame(self.root, ws, hs, self.remedy_db_controller, remedy_searcher)
        ...
        # Search remedy frame to search the remedy for input symptoms.
        # We can go back to login frame
        ...
        self.entry_frame.frame.add_next_frame(self.search_remedy_frame)
        ...
        # We can go back to login frame
        self.patient_registration_frame.frame.add_back_frame(self.login_frame)
        self.patient_registration_frame.frame.add_back_frame(self.entry_frame)
        self.patient_registration_frame.frame.add_next_frame(self.medical_record_frame)
        ...
        # From Patient Frame we can go next to:
        # TODO: -------
        # We can  ogo back to login framer patient frame
        ...
        # Currently we cannot go anywhere from search remedy frame.
        # From  Search Remedy frame we can go back to the entry frame.
        self.search_remedy_frame.frame.add_back_frame(self.entry_frame)
        self.back_up_frame.frame.add_back_frame(self.entry_frame)
